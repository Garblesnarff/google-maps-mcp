 ...
 */
export async function handleDistanceMatrix(origins, destinations, mode = "driving") {
 ...
 */
export async function handleDirections(origin, destination, mode = "driving") {
 ...
 */
export async function handleRoutes(origin, destination, travel_mode = "DRIVE", routing_preference = "TRAFFIC_UNAWARE") {
    ...
    try {
        const data = await postJson(url, requestBody, {
