 ...
 */
export async function downloadImage(imageUrl, customDir, customFilename) {
    try {
 ...
 * @returns {Promise<DownloadResult>} Result of the download operation.
 */
export async function downloadStreetViewImage(imageUrl, location, heading, pitch, customDir) {
 ...
 * @returns {Promise<DownloadResult>} Result of the download operation.
 */
export async function downloadStaticMapImage(imageUrl, center, maptype, zoom, customDir) {
